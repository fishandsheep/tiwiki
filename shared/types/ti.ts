import type { TournamentStatus } from '../ti-values'

export type { TournamentStatus } from '../ti-values'

export interface FieldProvenance {
  fieldName: string
  sourceKind: 'official' | 'liquipedia' | 'wikipedia' | 'curated'
  sourceUrl: string
  sourceRevision: string
  fetchedAt: string
  verificationStatus: 'verified' | 'single-source' | 'pending'
  note: string
}
